 ...
 * @Date 2021/9/7
 */
public class CircualSingleLinkedList<T> {
     ...
     * 构造空单链表
     */
    public CircualSingleLinkedList() {
     ...
     * @param datas 数据
     */
    public CircualSingleLinkedList(T[] datas) {
        this();
        if (datas != null) {
            for(int i = 0; i < datas.length; i++) {
                rear.next = new Node(datas[i], this.head);
                rear = rear.next;
            }
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        Node<T> p = this.head.next;
        Node<T> q = ((CircualSingleLinkedList<T>)o).head.next;
